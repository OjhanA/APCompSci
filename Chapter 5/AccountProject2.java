...
public class AccountProject2 {
     ...
     */
    public AccountProject2(double initBal, String owner, int number)
    {
        balance = initBal;
        name = owner;
        acctNum = number;
     ...
     * @param owner Owner of the account
     */
    public AccountProject2(double initBal, String owner)
    {
        balance = initBal;
        name = owner;
     ...
     * @param owner Owner of the account
     */
    public AccountProject2(String owner){
        balance = 0;
        name = owner;
        acctNum = nextAccountNum++;
    }
